...
const en: Dictionary = {
  ...
  experience: {
    ...
    items: [
      {
        company: "AMASA - Amazônia Indústria Alimentícias",
        role: "IT Manager / Full Stack",
        period: "2024 — 2025 · Present",
        bullets: [
          "Promoted to IT Manager. Shipped production systems: Sensores AMASA, Frequência-amasa, and JBFlexa Chat. Managed Proxmox/Endian, cutting hardware cost and strengthening security.",
          "Built IoT and full-stack solutions (Python/FastAPI/Flask, React/TypeScript, ESP32). Sustained Fortes ERP with high availability and operational support.",
        ],
      },
      {
        company: "RR CHEVROLET",
        ...
        period: "2023 — 2024",
        bullets: [
          "Resolved 500+ technical incidents, cutting mean resolution time by 40% through agile diagnosis and preventive action.",
          "Managed and monitored the NBS system with 99% uptime. Delivered 300+ remote sessions, solving 95% without on-site travel.",
        ],
      },
      {
        company: "Rodneycom Tecnologia e Serviços",
        ...
        period: "2018 — 2023",
        bullets: [
          "Built responsive React/TypeScript interfaces across 12+ projects, improving performance by up to 50%.",
          "Optimized 8 apps (load time from 3s to 0.8s) and maintained 12 legacy projects, raising maintainability and reducing bugs.",
        ],
      },
      {
        company: "MASTERDADOS",
        ...
        period: "2015 — 2018",
        bullets: [
          "Optimized access-control systems across 8 sites (−25% failures). Standardized 50+ terminals and configured 5 automation servers.",
        ],
      },
      {
        company: "WIFINET",
        ...
        period: "2013 — 2015",
        bullets: [
          "Supported 1,000+ customers, resolving 90% of requests remotely. Configured 200+ ONUs and monitored 300+ devices proactively.",
        ],
      },
    ],
  },
