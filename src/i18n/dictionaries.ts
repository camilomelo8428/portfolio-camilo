...
const pt: Dictionary = {
  ...
  projects: {
    ...
    revealHint: "Clique para investigar",
...
const en: Dictionary = {
  ...
  projects: {
    ...
    revealHint: "Click to investigate",
    ...
    items: [
      ...
      },
      {
        name: "Backup Pro Amasa",
        summary:
          "Corporate backup for files and SQL Server with scheduling, retention, and Google Drive sync (OAuth).",
        stack: "PyQt6, SQL Server, Google Drive API",
        production: "AMASA",
        highlights: [
          "Automated backup to multiple destinations",
          "Cloud upload with OAuth and configurable retention",
